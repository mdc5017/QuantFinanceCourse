...
class CAPM:
    ...
    def initialize(self):
        ...
        # logarithmic monthly returns - divide by previous value and then take ln
    ...
    def calculate_beta(self):
         # covariance matrix: the diagonal items are the variance
         # the off diagonals are the covariances
         # matrix is symmetric: cov[0,1] = cov[1,0]
...
if __name__ == '__main__':
        ...
        capm = CAPM(['IBM', '^GSPC'], '2009-12-31', '2017-01-01')
        capm.initialize()
        capm.calculate_beta()
        capm.regression()